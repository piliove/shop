...
<div class="card">
    <div class="card-body">
        ...
        <form class="forms-sample">
            <input type="hidden" name="token" value="{{$blog->_token}}">
            <input type="hidden" name="id" value="{{$blog->id}}">
            <div class="form-group">
                <label for="exampleTextarea1">新闻描述</label>
                <textarea class="form-control" name="title" value="{{ $blog->title }}" id="exampleTextarea1" placeholder="请输入描述信息" rows="4"></textarea>
            </div>
            <div class="form-group">
                <label for="exampleTextarea1">新闻内容</label>
                <textarea class="form-control" name="bdesc" value="{{ $blog->bdesc }}" id="exampleTextarea1" placeholder="请输入描述信息" rows="4"></textarea>
            </div>
            <div class="form-group">
                <label>上传图片</label>
                ...
                <img style="width:100px; height:100px; " src="/uploads/{{ $blog->ufate }}" name="ufate" id="ufate" alt="">
            </div>
        </form>
