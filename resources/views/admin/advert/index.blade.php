...
<div class="card">
    <div class="card-body">
        ...
        <a href="/admin/advert/create" style="margin-top:10px;" class="badge badge-info">
            <i class="mdi mdi-account-multiple-plus"></i>添加广告</a>
        <table class="table">
            <thead>
             <tr>
                <th>ID</th>
           ...
           <tbody>
                @foreach($advert as $k=>$v)
                    <tr>
                        <td>{{ $v->id }}</td>
                        <td style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">{{ $v->advert_title }}</td>
                        <td>
