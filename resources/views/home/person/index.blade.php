					...
					<div class="am-container header">
						...
						<ul class="message-r">
							...
							<div class="topMessage mini-cart">
								<div class="menu-hd"><a id="mc-menu-hd" href="/home/cart/index" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">()</strong></a></div>
							</div>
							...
							<div class="m-user">
								...
								<div class="m-userinfo">
									...
									<div class="m-right">
										...
										<div class="m-address">
											<a href="/home/addres" class="i-trigger">我的收货地址</a>
										</div>
									</div>
								</div>
								...
								<div class="s-content">
									...
									<div class="s-item-wrap">
										<div class="s-item">
											...
											<div class="s-title"><a href="/home/info/index/{{ $v->gid }}" title="{{ $v->ctitle }}">{{ $v->ctitle }}</a></div>
											<div class="s-extra-box">
												<span class="s-comment">好评: 00.00%</span>
												<span class="s-sales">月销: 000</span>
