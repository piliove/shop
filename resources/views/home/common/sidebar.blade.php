                ...
                <ul class="category-list" id="js_climit_li">
                    <li class="appliance js_toggle relative first">
                        <div class="category-info">
                            <h3 class="category-name b-category-name"><i><img src="/home/images/cake.png"></i><a
                    ...
                    <li class="appliance js_toggle relative">
                        <div class="category-info">
                            <h3 class="category-name b-category-name"><i><img
                                            src="/home/images/cookies.png"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a>
                            </h3>
                            <em>&gt;</em></div>
                        <div class="menu-item menu-in top">
                            <div class="area-in">
                    ...
                    <li class="appliance js_toggle relative">
                        <div class="category-info">
                            <h3 class="category-name b-category-name"><i><img src="/home/images/meat.png"></i><a
                    ...
                    <li class="appliance js_toggle relative">
                        <div class="category-info">
                            <h3 class="category-name b-category-name"><i><img src="/home/images/bamboo.png"></i><a
                    ...
                    <li class="appliance js_toggle relative">
                        <div class="category-info">
                            <h3 class="category-name b-category-name"><i><img src="/home/images/nut.png"></i><a
                    ...
                    <li class="appliance js_toggle relative">
                        <div class="category-info">
                            <h3 class="category-name b-category-name"><i><img
                                            src="/home/images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a>
                            </h3>
                            <em>&gt;</em></div>
                        <div class="menu-item menu-in top">
                            <div class="area-in">
                    ...
                    <li class="appliance js_toggle relative">
                        <div class="category-info">
                            <h3 class="category-name b-category-name"><i><img src="/home/images/chocolate.png"></i><a
                    ...
                    <li class="appliance js_toggle relative">
                        <div class="category-info">
                            <h3 class="category-name b-category-name"><i><img src="/home/images/fish.png"></i><a
                    ...
                    <li class="appliance js_toggle relative">
                        <div class="category-info">
                            <h3 class="category-name b-category-name"><i><img src="/home/images/tea.png"></i><a
                    ...
                    <li class="appliance js_toggle relative last">
                        <div class="category-info">
                            <h3 class="category-name b-category-name"><i><img
                                            src="/home/images/package.png"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a>
                            </h3>
                            <em>&gt;</em></div>
                        <div class="menu-item menu-in top">
                            <div class="area-in">
