		...
		<div class="am-container header">
			...
			<ul class="message-r">
				...
				<div class="topMessage mini-cart">
					<div class="menu-hd"><a id="mc-menu-hd" href="#" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">{{ $countCart }}</strong></a></div>
				</div>
			...
			<div class="concent">
								...
								<ul class="item-content clearfix">
									...
									<li class="td td-op">
										<div class="td-inner">
                                            ...
                                            移入收藏夹</a>
											<a href="/home/cart/delete?id={{ $v->id }}" data-point-url="#" class="delete">
                                            删除</a>
										</div>
									</li>
								</ul>
				...
				<div class="float-bar-wrapper">
					...
					<div class="float-bar-right">
						...
						<div class="btn-area">
							<a href="/home/orders/index" id="J_Go" class="submit-btn submit-btn-disabled" aria-label="请注意如果没有选择宝贝，将无法结算">
								<span>结&nbsp;算</span></a>
						</div>
					</div>
